...
String centerId = "dMb01bLvnuTS1qAGJzebGTs7qOr1";
...
class FirestoreService {
  ...
  Future<void> init() async {
    allSciences = await getAllSciences();
  ...
  Future<String?> deletePride(PrideModel pride) async {
    try {
      await _fb.collection(api.pride).doc(pride.id).delete();
    } catch(e) {
      print('deletePride: $e');
      return def.unknownError;
    }
