...
import 'package:maktab_234/pages/guest/school/inner/statute/view/chapter_detail.dart';
...
class GStatutePage extends StatefulWidget {
  const GStatutePage({super.key});

  @override
  State<GStatutePage> createState() => _GStatutePageState();
}

class _GStatutePageState extends State<GStatutePage> {
  @override
  Widget build(BuildContext context) {
    final size = MediaQuery.of(context).size;
    return ChangeNotifierProvider(
      create: (context) => GStatuteVM(null),
      child: Consumer<GStatuteVM>(
        builder: (context, GStatuteVM vm, _) {
