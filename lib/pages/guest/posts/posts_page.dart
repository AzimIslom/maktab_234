...
class GPostsPage extends StatelessWidget {
  const GPostsPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<GPostsVM>(
      create: (_) => GPostsVM(),
      child: Consumer<GPostsVM>(
        builder: (context, GPostsVM vm, _) {
