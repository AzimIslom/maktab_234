...
import 'package:maktab_234/pages/guest/school/inner/school_bio/school_bio_vm.dart';
...
class GWSchoolBioPage extends StatelessWidget {
  const GWSchoolBioPage({super.key});

  @override
  Widget build(BuildContext context) {
    final size = MediaQuery.of(context).size;
    return ChangeNotifierProvider(
      create: (context) => GSchoolBioVM(),
      child: Consumer<GSchoolBioVM>(
        builder: (context, GSchoolBioVM vm, _) {
          return Scaffold(
            appBar: AppBar(
